...
class Rabbi {
    ...
    private val suitPaint = Paint().apply {
    ...
    private val tiePaint = Paint().apply {
    ...
    private val beardPaint = Paint().apply {
        color = Color.WHITE
        style = Paint.Style.FILL
    }
    ...
    private val shoePaint = Paint().apply {
        color = Color.BLACK
        style = Paint.Style.FILL
    }
    ...
    private val stunPaint = Paint().apply {
        color = Color.YELLOW
        textSize = 18f
        textAlign = Paint.Align.CENTER
    }
